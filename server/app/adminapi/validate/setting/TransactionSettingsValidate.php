...
class TransactionSettingsValidate extends BaseValidate
{
    protected $rule = [
        ...
        'is_buy_btn' => 'require|in:1,2',
        'is_buy_btn_desc' => 'require',
    ];
    ...
    protected $message = [
        ...
        'is_buy_btn.require' => '请选择购买按钮',
        'is_buy_btn.in' => '购买按钮值有误',
        'is_buy_btn_desc.require' => '请输入按钮文字',
    ];

    public function sceneSetConfig()
    {
        return $this->only(['cancel_unpaid_orders','cancel_unpaid_orders_times','verification_orders','verification_orders_times','is_buy_btn','is_buy_btn_desc']);
    }
}