...
class TransactionSettingsLogic extends BaseLogic
{
    ...
    public static function getConfig()
    {
        $config = [
            ...
            'is_buy_btn' => ConfigService::get('transaction', 'is_buy_btn',1),
            'is_buy_btn_desc' => ConfigService::get('transaction', 'is_buy_btn_desc','立即购买'),
        ];
    ...
    public static function setConfig($params)
    {
        ...
        ConfigService::set('transaction', 'is_buy_btn', $params['is_buy_btn']);
        ConfigService::set('transaction', 'is_buy_btn_desc', $params['is_buy_btn_desc']);
    }
}