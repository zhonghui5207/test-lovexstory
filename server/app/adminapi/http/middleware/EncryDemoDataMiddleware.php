...
//        'config.interface_version',
    ...
    public function handle($request, \Closure $next)
    {
        ...
        foreach ($data['data'] as $key => $item) {
            ...
            foreach ($this->needCheckParams as $checkParam){
                if(!strstr($checkParam, '.')){
                    ...
                    $paramsList = explode('.',$checkParam);
                    $paramsKey = array_shift($paramsList);
                    $params = array_shift($paramsList);
                    if(isset($data['data'][$paramsKey][$params])){
                        $data['data'][$paramsKey][$params] = '******';
                    }
                }
