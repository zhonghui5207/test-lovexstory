...
{
    public array $notNeedLogin = ['resetPasswordCaptcha', 'resetPassword','customerService'];
    /**
     * @notes 个人中心
    ...
    {
        $result = (new UserLogic())->wallet($this->userId);
    ...
    {
        $result = (new UserLogic())->info($this->userInfo);
        return $this->data($result);
    }
    ...
    {
        $params = (new UserValidate())->post()->goCheck('changePassword',['user_id'=>$this->userId]);
