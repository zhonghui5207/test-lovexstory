...
{
    public array $notNeedLogin = ['register', 'account', 'logout', 'codeUrl', 'oaLogin',  'mnpLogin', 'uniAppLogin'];
    ...
    public function uniAppLogin(){
        $params = (new WechatLoginValidate())->post()->goCheck('uniAppLogin');
        $res = (new LoginLogic)->uniAppLogin($params);
        if(false === $res){
            return $this->fail(LoginLogic::getError());
        }
        return $this->success('',$res);
