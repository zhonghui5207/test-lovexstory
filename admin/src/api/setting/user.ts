...
export function withdraw(params?: any) {
    return request.get({ url: '/setting.user.user/getWithdrawConfig', params })
}
export function savewithdraw(data?: any) {
    return request.post({ url: '/setting.user.user/setWithdrawConfig', data })
}
