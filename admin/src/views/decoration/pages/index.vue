...
> = reactive({
    [pagesTypeEnum.HOME]: {
        ...
        type: 1,
        name: '首页装修',
        pageData: generatePageData(['search', 'banner', 'nav', 'special'])
    },
    [pagesTypeEnum.USER]: {
        id: 2,
        type: 2,
        name: '个人中心',
        pageData: generatePageData(['user-info', 'top-icon', 'my-service', 'user-banner'])
    },
...
const getData = async () => {
    ...
    menus[String(data.id)].pageData = data.data
}
